...
window.findAndReplaceDOMText = (function() {
   ...
   */
  function findAndReplaceDOMText(regex, node, replacementNode, replacementContent, captureGroup) {

    var m, matches = [], text = _getText(node);
    var replaceFn = _genReplacer(replacementNode, replacementContent);
   ...
   */
  function _genReplacer(nodeName, replacementContent) {
    ...
    return function replace(range) {
      ...
      if (startNode === endNode) {
		...
		var el = makeReplacementNode(replacementContent, matchIndex);
        ...
        var elA = makeReplacementNode(replacementContent, matchIndex);
        var innerEls = [];
		...
		var elB = makeReplacementNode("", matchIndex);
